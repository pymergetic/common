...
static ::nanobind::object _make_py_exc(const std::exception& e) {
  ...
  if (dynamic_cast<const pymergetic::common::MagicMismatchError*>(&e) != nullptr) {
    return ::nanobind::module_::import_("pymergetic.common.__cpp__").attr("MagicMismatchError")(msg);
  }
  if (dynamic_cast<const pymergetic::common::EndOfStreamError*>(&e) != nullptr) {
    return ::nanobind::module_::import_("pymergetic.common.__cpp__").attr("EndOfStreamError")(msg);
  }
  if (dynamic_cast<const pymergetic::common::CodecError*>(&e) != nullptr) {
    return ::nanobind::module_::import_("pymergetic.common.__cpp__").attr("CodecError")(msg);
  }
...
EASYBIND_REGISTER_PACKAGE("pymergetic.common", [](::nanobind::module_& m) { bind_net(m); });
